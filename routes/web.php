...
Route::get('/token-expired', 'PageController@tokenExpired')->name('token-expired');
...
Route::post('feedback-transaction', 'PayfortController@directFeedbackResponse')->name('feedback-transaction');
